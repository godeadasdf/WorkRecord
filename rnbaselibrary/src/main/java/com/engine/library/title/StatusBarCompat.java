...
public class StatusBarCompat {
    ...
    public static void translucentStatusBar(Activity activity,boolean isFit) {
        translucentStatusBar(activity, false,isFit);
    }
    /**
     * change to full screen mode
     * @param hideStatusBarBackground hide status bar alpha Background when SDK > 21, true if hide it
     */
    public static void translucentStatusBar(Activity activity, boolean hideStatusBarBackground,boolean isFit) {
        Window window = activity.getWindow();
        ViewGroup mContentView = (ViewGroup) activity.findViewById(Window.ID_ANDROID_CONTENT);
